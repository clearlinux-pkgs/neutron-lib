...
Version  : 2.4.0
Release  : 43
URL      : https://files.pythonhosted.org/packages/bb/27/10b8bfde09dc915fa44a28a6bfe68fdfcdae822aa237625430bea43216a7/neutron-lib-2.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/bb/27/10b8bfde09dc915fa44a28a6bfe68fdfcdae822aa237625430bea43216a7/neutron-lib-2.4.0.tar.gz
...
%prep
%setup -q -n neutron-lib-2.4.0
cd %{_builddir}/neutron-lib-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592610963
...
cp %{_builddir}/neutron-lib-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/neutron-lib/294b43b2cec9919063be1a3b49e8722648424779
