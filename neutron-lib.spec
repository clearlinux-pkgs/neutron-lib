...
Version  : 2.2.0
Release  : 40
URL      : https://files.pythonhosted.org/packages/0a/64/db7ce681a8fbce07f2ecf476c7a100a98780c5488f0e264f90c4e6d6f976/neutron-lib-2.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/64/db7ce681a8fbce07f2ecf476c7a100a98780c5488f0e264f90c4e6d6f976/neutron-lib-2.2.0.tar.gz
...
%prep
%setup -q -n neutron-lib-2.2.0
cd %{_builddir}/neutron-lib-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583864458
...
cp %{_builddir}/neutron-lib-2.2.0/LICENSE %{buildroot}/usr/share/package-licenses/neutron-lib/294b43b2cec9919063be1a3b49e8722648424779
